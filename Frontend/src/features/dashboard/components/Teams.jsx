      ...
      {isManageModalOpen && selectedUser && (
        <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white dark:bg-[#111] border border-neutral-200 dark:border-neutral-800 rounded-[2rem] p-6 md:p-8 w-full max-w-md shadow-2xl animate-[fadeIn_0.2s_ease-out]">
            ...
            <div className="flex items-center justify-between w-full pt-4 border-t border-neutral-200 dark:border-neutral-800">
              <button
                onClick={handleRemoveUser}
                className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-red-500 hover:bg-red-50 dark:hover:bg-red-950/30 font-medium transition-colors text-sm"
              >
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="py-2.5 px-5 rounded-xl bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 font-medium hover:opacity-90 transition-opacity shadow-sm text-sm"
                >
                  Save
                </button>
              </div>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right">
                      ...
                      <button 
                        ...
                        className="text-neutral-400 hover:text-neutral-900 dark:hover:text-white p-2 rounded-lg hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-colors"
                      >
